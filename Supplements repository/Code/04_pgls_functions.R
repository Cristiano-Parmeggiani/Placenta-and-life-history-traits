# =============================================================================
# PGLS functions with response error and estimated Pagel lambda
# =============================================================================
# Purpose: Define the generalized least-squares implementation used throughout the paper. The implementation is adapted from Compton et al. (2024) and phytools::pglsSEy.


# PGLS implementation adapted from Compton et al. (2024)
# -----------------------------------------------------------------------------
...
# Define the PGLS functions before fitting models.
# PGLS functions with response-error accommodation.
